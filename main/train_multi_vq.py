...
def main():
    ...
    # initialize wandb
    wandb.init(project="multitalk", name=args.save_path.split("/")[-1],dir="logs")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(cfg.start_epoch, cfg.epochs):
        ...
        wandb.log({"recon_loss_train": rec_loss_train, "quan_loss_train": quant_loss_train}, epoch_log)
        ...
        if cfg.evaluate and (epoch_log % cfg.eval_freq == 0):
            ...
            wandb.log({"recon_loss_val": rec_loss_val, "quan_loss_val": quant_loss_val}, epoch_log)

            #save_checkpoint
            if rec_loss_val<val_recon_loss_log:
                val_recon_loss_log, val_quan_loss_log = rec_loss_val, quant_loss_val
